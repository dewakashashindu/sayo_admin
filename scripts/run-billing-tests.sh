...
rm -rf .tmptest
"$TSC" src/lib/itemCode.ts src/lib/bookingStatus.ts src/lib/billingTaxes.ts src/lib/billingPayments.ts src/lib/billingBill.ts src/lib/inventoryTotals.ts src/lib/poRequirements.ts src/lib/poPrint.ts src/lib/poEmail.ts src/lib/poPdf.ts src/lib/companyLetterhead.ts src/lib/grnPoEntry.ts src/lib/grnNotify.ts src/lib/sms.ts src/lib/poReceiptState.ts src/lib/itemDetailStock.ts src/lib/rateLimit.ts src/lib/clientIp.ts src/lib/otpStore.ts \
