...
export const translations: Record<string, { en: string; si: string; ta: string }> = {
  ...
  /* "✓ Book as {order} at {slot}" needs 3 parts because word order differs per language */
  ...
  /* gap description generated in page.tsx handleSlotClick */
...
/* ─────────────────────────────────────────────────────────────
   SERVICE NAMES  (57 services — lookup by English name)
   NOTE: beauty/salon terms are often transliterated in real LK apps.
───────────────────────────────────────────────────────────── */
const serviceNames: Record<string, { si: string; ta: string }> = {
  /* WAX */
  'Full Arms Wax':            { si: 'සම්පූර්ණ අත් වැක්සින්',                    ta: 'முழு கை வேக்ஸிங்' },
  'Full Legs Wax':            { si: 'සම්පූර්ණ කකුල් වැක්සින්',                  ta: 'முழு கால் வேக்ஸிங்' },
  'Underarm Wax':             { si: 'කිහිලි වැක්සින්',                          ta: 'அக்குள் வேக்ஸிங்' },
  'Eyebrow Threading':        { si: 'බැම පෙළගැස්වීම (ත්‍රෙඩින්)',               ta: 'புருவம் சரிசெய்தல் (திரெடிங்)' },
  'Full Body Wax':            { si: 'සම්පූර්ණ ශරීර වැක්සින්',                   ta: 'முழு உடல் வேக்ஸிங்' },
  'Chest Wax':                { si: 'පපුව වැක්සින්',                            ta: 'மார்பு வேக்ஸிங்' },
  'Back Wax':                 { si: 'පිට වැක්සින්',                             ta: 'முதுகு வேக்ஸிங்' },
  'Beard Shaping':            { si: 'රැවුල හැඩගැස්වීම',                         ta: 'தாடி வடிவமைப்பு' },
  /* HAIR */
  'Cut & Re-Style':           { si: 'කපා නැවත හැඩගැස්වීම',                      ta: 'வெட்டி புதிய ஸ்டைல்' },
  'Fringe Cut':               { si: 'නෙතිපත කොණ්ඩය කැපීම (ෆ්‍රින්ජ්)',           ta: 'நெற்றி முடி வெட்டு (ஃபிரிஞ்)' },
  'Blow Dry (Short)':         { si: 'බ්ලෝ ඩ්‍රයි (කෙටි)',                      ta: 'ப்ளோ டிரை (குறுகிய முடி)' },
  'Hair Wash & Blast Dry':    { si: 'කොණ්ඩය සෝදා වියළීම',                       ta: 'முடி கழுவி உலர்த்துதல்' },
  'Trim':                     { si: 'ට්‍රිම්',                                  ta: 'ட்ரிம்' },
  'Haircut – Classic':        { si: 'සම්භාව්‍ය මුඩි කැපුම',                      ta: 'கிளாசிக் முடி வெட்டு' },
  'Beard Trim':               { si: 'රැවුල ට්‍රිම්',                            ta: 'தாடி ட்ரிம்' },
  'Hair Color':               { si: 'කොණ්ඩයට පාට කිරීම',                        ta: 'முடி நிறம்' },
  'Head Massage':             { si: 'හිස් සම්බාහනය',                            ta: 'தலை மசாஜ்' },
  /* SKIN */
  'Classic Facial':           { si: 'සම්භාව්‍ය ෆේෂියල්',                         ta: 'கிளாசிக் ஃபேஷியல்' },
  'Gold Facial':              { si: 'රන් ෆේෂියල්',                              ta: 'கோல்டு ஃபேஷியல்' },
  'Skin Brightening':         { si: 'සම දීප්තිමත් කිරීම',                       ta: 'சரும பிரகாசம்' },
  'Acne Treatment':           { si: 'ඇක්නේ ප්‍රතිකාරය',                         ta: 'முகப்பரு சிகிச்சை' },
  'Anti-Aging Facial':        { si: 'වයසට යාම වලක්වන ෆේෂියල්',                  ta: 'வயதான தோற்றத்தைக் குறைக்கும் ஃபேஷியல்' },
  'Deep Cleansing Facial':    { si: 'ගැඹුරු පිරිසිදු කිරීමේ ෆේෂියල්',            ta: 'ஆழ்ந்த சுத்தம் செய்யும் ஃபேஷியல்' },
  'Beard Care Facial':        { si: 'රැවුල රැකවරණ ෆේෂියල්',                     ta: 'தாடி பராமரிப்பு ஃபேஷியல்' },
  'Whitening Facial':         { si: 'සම සුදුකිරීමේ ෆේෂියල්',                    ta: 'வெண்மையாக்கும் ஃபேஷியல்' },
  'Detox Facial':             { si: 'ඩීටොක්ස් ෆේෂියල්',                         ta: 'நச்சு நீக்கும் ஃபேஷியல்' },
  /* NAIL */
  'Classic Manicure':         { si: 'සම්භාව්‍ය මැනිකියර්',                       ta: 'கிளாசிக் மெனிக்கியூர்' },
  'Gel Manicure':             { si: 'ජෙල් මැනිකියර්',                           ta: 'ஜெல் மெனிக்கியூர்' },
  'Classic Pedicure':         { si: 'සම්භාව්‍ය පෙඩිකියර්',                       ta: 'கிளாசிக் பெடிக்கியூர்' },
  'Gel Pedicure':             { si: 'ජෙල් පෙඩිකියර්',                           ta: 'ஜெல் பெடிக்கியூர்' },
  'Nail Art (Per Set)':       { si: 'නිය කලාව (සෙට් එකකට)',                     ta: 'நகக் கலை (ஒரு செட்டுக்கு)' },
  'Basic Manicure':           { si: 'මූලික මැනිකියර්',                          ta: 'அடிப்படை மெனிக்கியூர்' },
  'Basic Pedicure':           { si: 'මූලික පෙඩිකියර්',                          ta: 'அடிப்படை பெடிக்கியூர்' },
  'Nail Trim & Buff':         { si: 'නිය කැපීම සහ පිරිමැදීම',                   ta: 'நகம் வெட்டி தேய்த்தல்' },
  'Callus Removal':           { si: 'කැලස් ඉවත් කිරීම',                         ta: 'தடிமனான தோல் (காலஸ்) அகற்றல்' },
  'Hand Spa':                 { si: 'අත් ස්පා',                                 ta: 'கை ஸ்பா' },
  /* BODY */
  'Full Body Massage':        { si: 'සම්පූර්ණ ශරීර සම්බාහනය',                   ta: 'முழு உடல் மசாஜ்' },
  'Body Scrub':               { si: 'ශරීර ස්ක්‍රබ්',                            ta: 'உடல் ஸ்க்ரப்' },
  'Body Wrap':                { si: 'ශරීර එතීම (බොඩි රැප්)',                    ta: 'உடல் ரேப்' },
  'Aromatherapy Massage':     { si: 'ඇරෝමා තෙරපි සම්බාහනය',                     ta: 'அரோமாதெரபி மசாஜ்' },
  'Hot Stone Massage':        { si: 'රත් ගල් සම්බාහනය',                         ta: 'சூடான கல் மசாஜ்' },
  'Deep Tissue Massage':      { si: 'ගැඹුරු ටිෂූ සම්බාහනය',                     ta: 'ஆழ்ந்த திசு மசாஜ்' },
  'Sports Massage':           { si: 'ක්‍රීඩා සම්බාහනය',                         ta: 'விளையாட்டு மசாஜ்' },
  'Back Massage':             { si: 'පිට සම්බාහනය',                             ta: 'முதுகு மசாஜ்' },
  'Head & Shoulder Massage':  { si: 'හිස සහ උරහිස් සම්බාහනය',                   ta: 'தலை & தோள்பட்டை மசாஜ்' },
  /* BRIDAL */
  'Bridal Package – Full':    { si: 'මනාල පැකේජය — සම්පූර්ණ',                   ta: 'மணமகள் தொகுப்பு — முழுமை' },
  'Bridal Hair & Makeup':     { si: 'මනාල කොණ්ඩය සහ අලංකාරය',                   ta: 'மணமகள் முடி & ஒப்பனை' },
  'Pre-Bridal Package':       { si: 'විවාහයට පෙර මනාල පැකේජය',                  ta: 'திருமணத்திற்கு முன் மணமகள் தொகுப்பு' },
  'Trial Makeup':             { si: 'අත්හදා බලන අලංකාරය',                       ta: 'சோதனை ஒப்பனை' },
  'Bridal Draping':           { si: 'මනාල සාරි එතීම',                           ta: 'மணமகள் புடவை கட்டுதல்' },
  'Groom Package':            { si: 'ගෘම් පැකේජය',                              ta: 'மணமகன் தொகுப்பு' },
  'Groom Hair & Makeup':      { si: 'ගෘම් කොණ්ඩය සහ අලංකාරය',                   ta: 'மணமகன் முடி & ஒப்பனை' },
  'Pre-Groom Package':        { si: 'විවාහයට පෙර ගෘම් පැකේජය',                  ta: 'திருமணத்திற்கு முன் மணமகன் தொகுப்பு' },
  'Groom Facial':             { si: 'ගෘම් ෆේෂියල්',                             ta: 'மணமகன் ஃபேஷியல்' },
  'Groom Grooming':           { si: 'ගෘම් සැරසීම',                              ta: 'மணமகன் குரூமிங்' },
};
