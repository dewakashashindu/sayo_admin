...
export const translations: Record<string, { en: string; si: string; ta: string }> = {
  ...
  'multi.contactInfo':       { en: 'Contact Details',                                 si: 'සම්බන්ධතා විස්තර',                            ta: 'தொடர்பு விவரங்கள்' },
  'multi.contactNote':       { en: 'This phone number and email are used for every booking in this group.',
                                si: 'මෙම දුරකථන අංකය සහ විද්‍යුත් තැපෑල මෙම කණ්ඩායමේ සෑම වෙන්කිරීමක් සඳහාම භාවිතා වේ.',
                                ta: 'இந்த தொலைபேசி எண் மற்றும் மின்னஞ்சல் இந்த குழுவின் ஒவ்வொரு முன்பதிவுக்கும் பயன்படுத்தப்படுகிறது.' },
  'multi.person':            { en: 'Person {n}',                                      si: 'පුද්ගලයා {n}',                                ta: 'நபர் {n}' },
  'multi.addPerson':         { en: 'Add Person',                                      si: 'පුද්ගලයෙක් එක් කරන්න',                        ta: 'நபரைச் சேர்' },
  'multi.remove':            { en: 'Remove',                                          si: 'ඉවත් කරන්න',                                  ta: 'அகற்று' },
  'multi.personName':        { en: "Person's Name",                                   si: 'පුද්ගලයාගේ නම',                               ta: 'நபரின் பெயர்' },
  'multi.servicesFor':       { en: 'Services for this person',                        si: 'මෙම පුද්ගලයා සඳහා සේවා',                       ta: 'இந்த நபருக்கான சேவைகள்' },
  'multi.timeFor':           { en: 'Time for this person',                            si: 'මෙම පුද්ගලයා සඳහා වේලාව',                      ta: 'இந்த நபருக்கான நேரம்' },
  'multi.total':             { en: 'Total ({n} persons)',                             si: 'එකතුව (පුද්ගලයින් {n})',                       ta: 'மொத்தம் ({n} நபர்கள்)' },
  'multi.submitAll':         { en: 'Book All ({n})',                                  si: 'සියල්ල වෙන්කරන්න ({n})',                       ta: 'அனைத்தையும் முன்பதிவு செய் ({n})' },
  'multi.submitting':        { en: 'Booking all…',                                    si: 'සියල්ල වෙන්කරමින්…',                           ta: 'அனைத்தையும் முன்பதிவு செய்கிறது…' },
  'multi.successTitle':      { en: 'All Bookings Received',                           si: 'සියලු වෙන්කිරීම් ලැබුණි',                       ta: 'அனைத்து முன்பதிவுகளும் பெறப்பட்டன' },
  'multi.successSub':        { en: '{n} booking(s) registered successfully.',         si: 'වෙන්කිරීම් {n}ක් සාර්ථකව ලියාපදිංචි විය.',         ta: '{n} முன்பதிவு(கள்) வெற்றிகரமாக பதிவு செய்யப்பட்டன.' },
  'multi.doneAnother':       { en: 'Book Another Group',                              si: 'තවත් කණ්ඩායමක් වෙන්කරන්න',                     ta: 'மற்றொரு குழுவை முன்பதிவு செய்' },
  'multi.me':                { en: 'ME',                                               si: 'මම',                                          ta: 'நான்' },
  'multi.guest':             { en: 'Guest {n}',                                        si: 'ආගන්තුකයා {n}',                              ta: 'விருந்தினர் {n}' },
  'multi.addGuest':          { en: 'Add Guest',                                        si: 'ආගන්තුකයෙක් එක් කරන්න',                      ta: 'விருந்தினரைச் சேர்' },
  'multi.meSub':             { en: 'Main client of this group',                        si: 'මෙම කණ්ඩායමේ ප්‍රධාන සේවාදායකයා',             ta: 'இந்தக் குழுவின் முக்கிய வாடிக்கையாளர்' },
  'multi.guestSub':          { en: 'Additional client',                                si: 'අමතර සේවාදායකයෙක්',                          ta: 'கூடுதல் வாடிக்கையாளர்' },
  'multi.autoDate':          { en: 'Auto-filled with the same date as ME',             si: 'මා සමඟ එකම දිනය ස්වයංක්‍රීයව පුරවා ඇත',      ta: 'நான் தேர்ந்தெடுத்த அதே தேதி தானாக நிரப்பப்பட்டது' },
  'multi.yourDetails':       { en: 'Your Details',                                     si: 'ඔබේ විස්තර',                                 ta: 'உங்கள் விவரங்கள்' },
  'multi.yourDetailsNote':   { en: 'Used for every booking in this group and auto-filled from your account.',
                               si: 'මෙම කණ්ඩායමේ සෑම වෙන්කිරීමක් සඳහාම භාවිතා වන අතර ඔබේ ගිණුමෙන් ස්වයංක්‍රීයව පුරවා ඇත.',
                               ta: 'இந்தக் குழுவின் ஒவ்வொரு முன்பதிவுக்கும் பயன்படுத்தப்படுகிறது மற்றும் உங்கள் கணக்கிலிருந்து தானாக நிரப்பப்படுகிறது.' },
  'multi.noNameNeeded':      { en: 'No name needed — labelled automatically',          si: 'නම අවශ්‍ය නැත — ස්වයංක්‍රීයව ලේබල් වේ',          ta: 'பெயர் தேவையில்லை — தானாக லேபிளிடப்படும்' },
  'multi.reviewTitle':       { en: 'Review Your Bookings',                             si: 'ඔබේ වෙන්කිරීම් සමාලෝචනය කරන්න',                    ta: 'உங்கள் முன்பதிவுகளை மதிப்பாய்வு செய்யுங்கள்' },
  'multi.reviewSub':         { en: "Check every person's services, provider, date and time before confirming.",
                               si: 'තහවුරු කිරීමට පෙර සෑම පුද්ගලයෙකුගේම සේවා, සැපයුම්කරු, දිනය සහ වේලාව පරීක්ෂා කරන්න.',
                               ta: 'உறுதிப்படுத்துவதற்கு முன் ஒவ்வொருவரின் சேவைகள், வழங்குநர், தேதி மற்றும் நேரத்தைச் சரிபார்க்கவும்.' },
  'multi.reviewAll':         { en: 'Review & Book ({n})',                              si: 'සමාලෝචනය සහ වෙන්කරන්න ({n})',                    ta: 'மதிப்பாய்வு & முன்பதிவு ({n})' },
  'multi.confirmAll':        { en: 'Confirm All ({n})',                                si: 'සියල්ල තහවුරු කරන්න ({n})',                       ta: 'அனைத்தையும் உறுதிப்படுத்து ({n})' },
  'multi.confirming':        { en: 'Confirming all…',                                  si: 'සියල්ල තහවුරු කරමින්…',                          ta: 'அனைத்தையும் உறுதிப்படுத்துகிறது…' },
  'multi.conflictBy':        { en: 'Already selected by {name}',                       si: 'දැනටමත් {name} විසින් තෝරාගෙන ඇත',                 ta: 'ஏற்கனவே {name} ஆல் தேர்ந்தெடுக்கப்பட்டது' },
  'multi.groupConflictNote': { en: 'Slots already taken by someone else in this group are disabled.',
                               si: 'මෙම කණ්ඩායමේ වෙනත් කෙනෙකු විසින් දැනටමත් ගෙන ඇති වේලාවන් අක්‍රීයයි.',
                               ta: 'இந்தக் குழுவில் வேறு ஒருவரால் ஏற்கனவே எடுக்கப்பட்ட நேரங்கள் முடக்கப்பட்டுள்ளன.' },
  'multi.errName':           { en: "Enter the person's name.",                        si: 'පුද්ගලයාගේ නම ඇතුළත් කරන්න.',                 ta: 'நபரின் பெயரை உள்ளிடவும்.' },
  'multi.errServices':       { en: 'Choose at least one service.',                    si: 'අවම වශයෙන් එක් සේවයක්වත් තෝරන්න.',            ta: 'குறைந்தது ஒரு சேவையையாவது தேர்ந்தெடுக்கவும்.' },
  'multi.errProvider':       { en: 'Choose a provider.',                              si: 'සේවා සැපයුම්කරුවෙකු තෝරන්න.',                 ta: 'ஒரு வழங்குநரைத் தேர்ந்தெடுக்கவும்.' },
  'multi.errDate':           { en: 'Pick a date.',                                    si: 'දිනයක් තෝරන්න.',                              ta: 'தேதியைத் தேர்ந்தெடுக்கவும்.' },
  'multi.errTime':           { en: 'Pick a time slot.',                               si: 'වේලාවක් තෝරන්න.',                             ta: 'ஒரு நேரத்தைத் தேர்ந்தெடுக்கவும்.' },
  'multi.fillGuest':         { en: "Please complete {name}'s details",                si: 'කරුණාකර {name} ගේ විස්තර සම්පූර්ණ කරන්න',       ta: 'தயவுசெய்து {name} இன் விவரங்களை நிரப்பவும்' },
  'multi.conflictAt':        { en: "{name}'s time slot was just taken — please choose another time.",
                                si: '{name} ගේ වේලාව දැන් වෙනත් කෙනෙකු විසින් ගෙන ඇත — වෙනත් වේලාවක් තෝරන්න.',
                                ta: '{name} இன் நேரம் இப்போது எடுக்கப்பட்டது — வேறு நேரத்தைத் தேர்ந்தெடுக்கவும்.' },
  'multi.partial':           { en: 'Some bookings were created, but not all. References:',
